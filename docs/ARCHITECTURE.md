...
- `HoldArcGestureDetector` po 500 ms stabilizacji wymaga odwróconego kapsla (grawitacja na dodatniej osi Z), bez udziału przycisku wyznacza lokalną oś X i estymuje ograniczonym całkowaniem ruch w prawo/lewo oraz pionową głębokość łuku. Kierunek wymaga spójnego czasu, szczytu i impulsu; akcja wymaga około 10 cm ruchu od pozycji początkowej do końcowej, obu faz pionowego łuku, hamowania po około 4 cm przemieszczenia oraz obniżenia prędkości. Ruch prosty, zbyt głęboki, dłuższy niż około 16 cm, poza osią lub obrotowy jest unieważniany; prawo daje Like, lewo Dislike, a po akcji detektor samoczynnie uzbraja się po krótkim uspokojeniu ruchu.
