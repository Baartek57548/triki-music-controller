...
- `HoldArcGestureDetector` po 500 ms przytrzymania wymaga odwróconego kapsla (grawitacja na dodatniej osi Z), wyznacza lokalną oś X i estymuje ograniczonym całkowaniem ruch w prawo/lewo oraz pionową głębokość łuku. Kierunek wymaga spójnego czasu, szczytu i impulsu; akcja wymaga 20–30 cm ruchu, obu faz pionowego łuku, hamowania po zauważalnym przemieszczeniu oraz obniżenia prędkości. Ruch prosty, zbyt głęboki, zbyt długi, poza osią lub obrotowy jest unieważniany; prawo daje Like, lewo Dislike, maksymalnie raz do puszczenia przycisku.
