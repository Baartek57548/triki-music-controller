...
Aktualizator Windows pobiera instalator do pliku `.download` z wyłączonym współdzieleniem, domyka strumienie HTTP i plikowe, a dopiero potem sprawdza rozmiar, SHA-256 i nagłówek PE. Zweryfikowany plik jest atomowo przenoszony pod docelową nazwę; krótkie blokady skanera antywirusowego są obsługiwane ograniczonym ponowieniem. Instalator uruchamia się wyłącznie z prywatnego katalogu aktualizacji aplikacji.
