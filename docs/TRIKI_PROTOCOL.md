...
- Stabilizacja przez co najmniej 500 ms i kapsel odwrócony górą w dół (dodatnia oś Z) otwierają detektor obrotu osi Z; przycisk nie jest wymagany. Wewnętrzny próg całkowania 245° kompensuje około 20–25° tracone przez filtry na początku i końcu ruchu, dlatego odpowiada fizycznemu obrotowi dłoni o około 270°. Ze względu na odwrócenie kapsla ruch dłoni w lewo przechodzi do następnego utworu, a w prawo do poprzedniego. Zatrzymanie, zmiana kierunku, niestabilne przyspieszenie lub luka strumienia zerują estymator.
