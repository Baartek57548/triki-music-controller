...
- Stabilizacja przez co najmniej 500 ms i kapsel odwrócony górą w dół (dodatnia oś Z) otwierają krótkie okno detekcji parabolicznego łuku; przycisk nie jest wymagany. Ruch w prawo po osi X daje Like, ruch w lewo Dislike; wymagane jest około 10 cm ruchu poziomego od pozycji początkowej do końcowej, pionowa faza łuku i łagodne hamowanie. Po poprawnym łuku detektor czeka na krótkie uspokojenie ruchu i uzbraja się ponownie; luka strumienia zeruje estymator.
