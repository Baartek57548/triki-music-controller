...
- Stabilizacja przez co najmniej 500 ms i kapsel odwrócony górą w dół (dodatnia oś Z) otwierają detektor pełnego obrotu osi Z; przycisk nie jest wymagany. Dodatni obrót w prawo przechodzi do następnego utworu, ujemny w lewo do poprzedniego. Estymowane 330° kompensuje niewielką stratę filtracji i wymaga fizycznie pełnego obrotu; zatrzymanie, zmiana kierunku, niestabilne przyspieszenie lub luka strumienia zerują estymator.
