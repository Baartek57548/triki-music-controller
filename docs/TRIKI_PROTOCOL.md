...
- Przytrzymanie przez co najmniej 500 ms i kapsel odwrócony górą w dół (dodatnia oś Z) otwiera krótkie okno detekcji parabolicznego łuku. Ruch w prawo po osi X daje Like, ruch w lewo Dislike; wymagane jest 20–30 cm ruchu poziomego, pionowa faza łuku i łagodne hamowanie. Poprawny łuk konsumuje bieżące przytrzymanie, więc puszczenie nie jest liczone jako dodatkowy klik; luka strumienia lub utrata flagi przycisku zeruje estymator.
